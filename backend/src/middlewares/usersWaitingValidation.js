    ...
    return [
        ...
        body('birthday')
            ...
            .custom((value)=>{
                ...
                if(!regexValidateDate.test(value) || year > currentYear || year<=currentYear - 130){
...
const userWaitingValidation={
    createUserWaiting
}

module.exports=userWaitingValidation